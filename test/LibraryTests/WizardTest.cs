...
namespace Program.Tests
{
    ...
    public class WizardTests
    {
        ...
        {
            // Arrange
            var wizard = new Wizard("Merlin", 100, 100, 0);
        ...
        {
            // Arrange
            var wizard = new Wizard("Gandalf", 100, 100, 0);
        ...
        {
            // Arrange
            var wizard = new Wizard("Gandalf", 50, 100, 0);
            var badGuy = new BadGuy("Orc", 50, 50, 2);
        ...
        {
            // Arrange
            var wizard = new Wizard("Gandalf", 60, 100, 5); 
            var badGuy = new BadGuy("Orc", 10, 10, 2); 
            var spell = new Attack("Fireball", 20);
